...
#
#   docker build -t school-erp-admin-web ./admin-web
#   docker build --target development -t school-erp-admin-web:dev ./admin-web
...
# Dev image: place before production so the default build target stays production.
